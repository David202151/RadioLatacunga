...
class FillPermissionsForSolicitudesMantenimiento extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSolicitudesMantenimiento constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.solicitudes-mantenimiento',
            'admin.solicitudes-mantenimiento.index',
            'admin.solicitudes-mantenimiento.create',
            'admin.solicitudes-mantenimiento.show',
            'admin.solicitudes-mantenimiento.edit',
            'admin.solicitudes-mantenimiento.delete',
            'admin.solicitudes-mantenimiento.bulk-delete',
        ]);
