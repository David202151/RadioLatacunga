...
class FillPermissionsForComponente extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForComponente constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.componente.create',
            'admin.componente.show',
            'admin.componente.edit',
            'admin.componente.delete',
            'admin.componente.bulk-delete',
        ]);
