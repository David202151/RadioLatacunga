...
class FillPermissionsForMantenimiento extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMantenimiento constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.mantenimiento',
            'admin.mantenimiento.index',
            'admin.mantenimiento.create',
            'admin.mantenimiento.show',
            'admin.mantenimiento.edit',
            'admin.mantenimiento.delete',
            'admin.mantenimiento.bulk-delete',
        ]);
